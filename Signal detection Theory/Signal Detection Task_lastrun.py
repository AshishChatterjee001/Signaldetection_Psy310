...
expName = 'Signal Detection Task'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\Lab in Psych\\Signal detection Theory\\Signal Detection Task_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text="Press '↑' if a tilt is present and '↓' if tilt is not present.\n\nPress 'SPACE' when you want to start",
        font='Arial',
